			...
			<div style="background-color:white;">
				<div class="row">			
					...
					<div class="col-md-10">
						...
						<div class="row" >
						<div class="col-md-11" style="color:grey;overflow: hidden;white-space:nowrap;">
						<?php echo $row['description'];?> 
						</div>
						<div class="col-md-1" style="color:black;padding-left:0px;">
						<a href="http://localhost/prasanth/book_details.php?id=<?php echo $row['book_id']?>" ><span style="float:right;">more</a><span style="float:right;">......</span>						
						</div>		
						</div>
					</div>	
				</div>
